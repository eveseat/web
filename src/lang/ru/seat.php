...
return [
    ...
    'affiliation'           => 'Отношение|Отношения',
    'role'                  => 'Роль|Роли',
    'edit'                  => 'Редактировать',
    'remove'                => 'Удалить',
    'yes'                   => 'Да',
    ...
    'switch_character'      => 'Переключить персонаж',
    'link_character'        => 'Привязать еще персонаж',
    ...
    'access'                => 'Управление правом допуска',
    'other'                 => 'Иное',
    'tools'                 => 'Инструменты',
    'security_logs'         => 'Записи логово безопасности',
    ...
    'contacts'                    => 'Контакты',
    'contracts'                   => 'Контракты',
    'fittings'                    => 'Комплектация кораблей',
    ...
    'total_character_skillpoints' => 'Итого очков умения',
    ...
    'quick_add_role'              => 'Быстро добавить роль',
    'role_name'                   => 'Название роли',
    'add_new_role'                => 'Добавить новую роль',
    'available_roles'             => 'Доступные рои',
    ...
    'inverse_permission'          => 'Вернуть разрешения',
    'inverse_affiliation'         => 'Вернуть установление связи',
    ...
    'add_affiliations'            => 'Добавить присоединение',
    'current_affiliations'        => 'Текущие присоединения',
    ...
    // Users
    'user_management'              => 'Редактирование пользователя',

    // Settings
    'admin_email'                  => 'Email администратора',
    'admin_email_help'             => 'Пожалуйста введите email для администратора для установки SEAT.',
    ...
    'tracking_help'                => 'Прежде чем отключить отслеживание пользователя, пожалуй посмотрите' .
        ' документ ниже.',
    'worker'                       => 'Рабочий процеес|Рабчие процессы',
    ...
    'client_secret_status'         => 'Безопасность клиента. Статус. ',
    'client_secret_ok'             => 'Безопасность клиента корректна',
    'client_secret_not_ok'         => 'Безопасность клиента не корректна. Проверьте .env файл',
    'callback_url_status'          => 'Отозвать статус URL',
    'callback_url_ok'              => 'Отзыв статуса URL OK как :url',
    'callback_maybe_wrong'         => 'Отзыв статуса URL не корректный. Сейчас установлен как :current ' .
        'возможно должен быть :suggested',
    'client_callback_not_ok'       => 'Отзыв URL не установлен. Проверьте файл .env и установите как ссылку :url',
    ...
    // Character
    'joined_curr_corp'             => 'Присоединился к текущей корпорации',
    ...
    'security_status'              => 'Уровень статуса безопасности',
    ...
    'skills_summary'               => 'Итого навыков',
    'curr_training'                => 'Сейчас в обучении',
    ...
    'implants'                     => 'Имплантант|Имплантаты',
    'no_implants'                  => 'Нет имплантатов',
    'employment_history'           => 'Стаж работы',
    'no_employment_information'    => 'Нет информации о стаже работы',
    'corporation_titles'           => 'Название корпорации|Названия корпорации',
    'no_corporation_titles'        => 'Нет названия корпорации',
    'attribute'                    => 'Атрибут|Атрибуты',
    'value'                        => 'Ценность|Ценности',
    'bonus_remaps'                 => 'Бесплатное перераспределение статистик',
    'last_remap_date'              => 'Дата последнего перераспределения статистик',
    'accrued_remap_cooldown_date'  => 'Дата ожидания до следующего перераспределения статистик',
    ...
    'seat_skin'                    => 'SeAT внеший вид',
    'language'                     => 'Язык',
    'sidebar_size'                 => 'Размер экрана',
    'mail_as_threads'              => 'Смотреть почту как записи по темам',
    ...
    'account_help'                 => 'По любым вопросам связанным с аккаунтом, включая разрешения, ' .
        'пожалуйста свяжитесь с администратором SeAT.',
    ...
    'third_party_access'           => 'Проверьте что доступ сторонних приложений (как это) разрешен' .
        'к вашем аккаунту.',
