@extends('web::layouts.alliance', ['viewname' => 'monitoring', 'breadcrumb' => trans('web::seat.monitoring')])

@section('page_description', trans_choice('web::seat.alliance', 1) . ' ' . trans('web::seat.monitoring'))
