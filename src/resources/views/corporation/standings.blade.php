...
@section('title', ucfirst(trans_choice('web::corporation.corporation', 1)) . ' Standings')
@section('page_header', ucfirst(trans_choice('web::corporation.corporation', 1)) . ' Standings')
