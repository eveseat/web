...
@section('page_header', trans_choice('web::seat.corporation', 1) . ' ' . trans('web::seat.jump_bridges'))
...
@section('ledger_content')
      ...
      @foreach ($periods->chunk(12) as $chunk)
        <ul class="nav justify-content-between">
          ...
          @foreach ($chunk as $period)
            <li class="nav-item">
              <a href="{{ route('corporation.view.ledger.jump_bridges', ['corporation_id' => $corporation_id, 'year' => $period->year, 'month' => $period->month]) }}" class="nav-link">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">{{ trans_choice('web::seat.jump_bridges', 2) }}
