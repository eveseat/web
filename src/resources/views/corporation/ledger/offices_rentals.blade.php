@extends('web::layouts.corporation', ['viewname' => 'offices_rentals', 'breadcrumb' => trans('web::seat.seat.offices_rentals')])
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <div class="col-auto me-5">
                <h3 class="card-title">{{ trans_choice('web::seat.offices_rentals', 2) }} - {{ date("M Y", strtotime(sprintf('%d-%d-01', $year, $month))) }}</h3>
            </div>
        </div>
        <div class="card-body">
