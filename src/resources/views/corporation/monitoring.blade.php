@extends('web::layouts.corporation', ['viewname' => 'monitoring', 'breadcrumb' => trans('web::seat.monitoring')])

@section('page_description', trans_choice('web::seat.corporation', 1) . ' ' . trans('web::seat.monitoring'))
