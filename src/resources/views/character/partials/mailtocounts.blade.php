@if($row->recipients->where('recipient_type', 'alliance')->count() > 0)
  <span data-widget="tooltip" data-placement="top" title="" data-original-title="Alliances">
...
@if($row->recipients->where('recipient_type', 'corporation')->count() > 0)
  <span data-widget="tooltip" data-placement="top" title="" data-original-title="Corporations">
...
@if($row->recipients->where('recipient_type', 'character')->count() > 0)
  <span data-widget="tooltip" data-placement="top" title="" data-original-title="Characters">
...
@if($row->recipients->where('recipient_type', 'mailing_list')->count() > 0)
  <span data-widget="tooltip" data-placement="top" title="" data-original-title="Mailing Lists">
