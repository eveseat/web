...
@section('title', ucfirst(trans_choice('web::character.character', 1)) . ' Wallet Transactions')
@section('page_header', ucfirst(trans_choice('web::character.character', 1)) . ' Wallet Transactions')
