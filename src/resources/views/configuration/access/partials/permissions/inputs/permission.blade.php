<div class="form-check mb-3">
  ...
  <label for="permission-{{ $scope }}-{{ $ability }}" class="form-check-label">
    @switch($division)
      @case('military')
        <span class="badge badge-danger" data-bs-toggle="tooltip" data-title="{{ trans('web::permissions.military_division') }}">
          <i class="fas fa-rocket"></i>
        </span>
        @break
      @case('assets')
        <span class="badge badge-warning" data-bs-toggle="tooltip" data-title="{{ trans('web::permissions.assets_division') }}">
          <i class="fas fa-cubes"></i>
        </span>
        @break
      @case('financial')
        <span class="badge badge-success" data-bs-toggle="tooltip" data-title="{{ trans('web::permissions.financial_division') }}">
          <i class="far fa-money-bill-alt"></i>
        </span>
        @break
      @case('industrial')
        <span class="badge badge-primary" data-bs-toggle="tooltip" data-title="{{ trans('web::permissions.industrial_division') }}">
          <i class="fas fa-industry"></i>
        </span>
        @break
      @default
        <span class="badge badge-default" data-bs-toggle="tooltip" data-title="{{ trans('web::permissions.no_division') }}">
