...
return [
    ...
    // Corporation Scope
    'corporation_asset_label'                         => 'Accorder l\'accès aux immobilisations de corporation',
    'corporation_asset_description'                   => 'Les immobilisations de la corporation montrent tous les éléments lui appartenant, leur emplacement et leur quantité.',
    'corporation_asset_first_division_label'          => 'Accorder l\'accès aux immobilisations de corporation dans la première division',
    'corporation_asset_first_division_description'    => 'Permet de consulter toutes les immobilisations d\'une corporation, présentes dans la première division.',
    'corporation_asset_second_division_label'         => 'Accorder l\'accès aux immobilisations de corporation dans la seconde division',
    'corporation_asset_second_division_description'   => 'Permet de consulter toutes les immobilisations d\'une corporation, présentes dans la seconde division.',
    'corporation_asset_third_division_label'          => 'Accorder l\'accès aux immobilisations de corporation dans la troisième division',
    'corporation_asset_third_division_description'    => 'Permet de consulter toutes les immobilisations d\'une corporation, présentes dans la troisième division.',
    'corporation_asset_fourth_division_label'         => 'Accorder l\'accès aux immobilisations de corporation dans la quatrième division',
    'corporation_asset_fourth_division_description'   => 'Permet de consulter toutes les immobilisations d\'une corporation, présentes dans la quatrième division.',
    'corporation_asset_fifth_division_label'          => 'Accorder l\'accès aux immobilisations de corporation dans la cinquième division',
    'corporation_asset_fifth_division_description'    => 'Permet de consulter toutes les immobilisations d\'une corporation, présentes dans la cinquième division.',
    'corporation_asset_sixth_division_label'          => 'Accorder l\'accès aux immobilisations de corporation dans la sixième division',
    'corporation_asset_sixth_division_description'    => 'Permet de consulter toutes les immobilisations d\'une corporation, présentes dans la sixième division.',
    'corporation_asset_seventh_division_label'        => 'Accorder l\'accès aux immobilisations de corporation dans la septième division',
    'corporation_asset_seventh_division_description'  => 'Permet de consulter toutes les immobilisations d\'une corporation, présentes dans la septième division.',
