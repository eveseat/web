 ...
 *
 * @package Seat\Web\Http\Controllers\Alliance
 */
class MonitoringController extends Controller
{
    ...
    {
        $entries = JobsTracking::where('entity_id', $alliance->alliance_id)->get();

        return view('web::alliance.monitoring', compact('alliance', 'entries'));
    }
}
