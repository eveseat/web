...
class AllianceMenu extends AbstractMenu
{
    ...
    {
        $this->alliance = request()->alliance;
    }
    ...
    public function compose(View $view)
    {
        ...
        if (! empty(config('package.alliance.menu'))) {
            foreach (config('package.alliance.menu') as $menu_data) {
                $prepared_menu = $this->load_plugin_menu('alliance', $menu_data, true);
    ...
    {
        return Gate::any($permissions, $this->alliance);
    }
}
