...
/**
 * Class CharacterContactScope.
 *
 * This is a specific scope for character contacts tables.
 ...
 */
class CharacterContactScope implements DataTableScope
{
    /**
     * @var string
     */
    ...
    public function apply($query)
    {
        ...
        return $query->whereIn('character_contacts.character_id', $character_ids);
    }
}
