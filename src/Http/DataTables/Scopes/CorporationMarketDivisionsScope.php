...
/**
 * Class CorporationMarketDivisionsScope.
 *
 * This is a corporation market division scope.
 * It will restrict user to the specified divisions.
 *
 * @package Seat\Web\Http\DataTables\Scopes
 */
class CorporationMarketDivisionsScope implements DataTableScope
{
    /**
     * @var array
     */
    ...
    {
        return $query->whereIn('wallet_division', $this->divisions);
    }
}
