...
use Seat\Web\Http\DataTables\Common\Intel\AbstractCalendarDataTable;
 ...
 */
class CalendarDataTable extends AbstractCalendarDataTable
{
    /**
    ...
    {
        return CharacterCalendarEvent::query();
    }
}
